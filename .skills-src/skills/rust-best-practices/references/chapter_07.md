...
let person: Person = Builder::new().age(30).name("name".to_string()).email("myself@example.com".to_string()).build();
...
let person: Person = Builder::new().age(30).email("myself@example.com".to_string()).build(); // ❌ Compile error: Name required to `build`
