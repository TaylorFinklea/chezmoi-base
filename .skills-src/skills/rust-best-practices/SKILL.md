...
Apply these guidelines when writing or reviewing Rust code. Based on Apollo GraphQL's Rust Best Practices Handbook (`apollographql/rust-best-practices` on GitHub).
